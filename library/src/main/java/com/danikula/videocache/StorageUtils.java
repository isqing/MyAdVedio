...
final class StorageUtils {
    ...
    private static final String INDIVIDUAL_DIR_NAME = "music-cache";
    ...
    private static File getCacheDirectory(Context context, boolean preferExternal) {
        ...
        if (appCacheDir == null) {
            ...
            MyLog.w(LOG_TAG, "Can't define system cache directory! '" + cacheDirPath + "%s' will be used.");
    ...
    private static File getExternalCacheDir(Context context) {
        ...
        if (!appCacheDir.exists()) {
            if (!appCacheDir.mkdirs()) {
                MyLog.w(LOG_TAG, "Unable to create external cache directory");
                return null;
            }
        }
        return appCacheDir;
