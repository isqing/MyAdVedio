...
import com.example.admin.myadvedio.CacheActivity;
import com.example.admin.myadvedio.MainActivity;
...
public class VideoViewDemo extends Activity {
	...
	private void init() {
		...
		mPath.setText("https://raw.githubusercontent.com/danikula/AndroidVideoCache/master/files/orange1.mp4");
		...
		//mPath.setText("http://bbfile.b0.upaiyun.com/data/videos/2/test22.mp4");  
		...
		mPause.setOnClickListener(new OnClickListener() {
			public void onClick(View view) {
				...
				Intent intent = new Intent();
				intent.setClass(VideoViewDemo.this, MainActivity.class);
				startActivity(intent);
			}
		});
...
//				}
				Intent intent = new Intent();
				intent.setClass(VideoViewDemo.this, CacheActivity.class);
				startActivity(intent);
			}
		});
